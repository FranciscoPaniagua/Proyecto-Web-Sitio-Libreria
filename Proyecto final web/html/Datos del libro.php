...
$sql = "SELECT  li.isbn, li.titulo,li.idioma,li.anio,li.editorial,li.idAutor,li.idGenero,concat(a.Nombre,' ',a.ApellidoP,' ',a.ApellidoM) as autor,g.nombre,
li.link, li.imagen from libros li, autor a, genero g where li.idAutor=a.idAutor and g.idGenero=li.idGenero and li.isbn='".$_SESSION['isbn']."'";
