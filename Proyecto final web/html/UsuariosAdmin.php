...
<div id="top">
	...
	<a href="../html/Inicio.php">
		<input class="boton" type='submit' value='Salir' style="background-color: #86af49; color: #ffffff; margin-left: 1100px;">
	</a>
	</form>
</div>
<br>
...
$sql = "SELECT email,usuario FROM usuarios limit 10 offset 0";
...
<br>
<button name="izq" onclick="mover(this);">Atrás</button>
<button name="der" onclick="mover(this);">Adelante</button>
</div>
